        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('markscrud.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <select name="student_id" id="student_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                ...
                                @foreach($students as $student)
                                    <option value="{{ $student->id }}">{{ $student->name }} ({{ $student->class->name ?? 'N/A' }}) ({{ $student->class->year }})</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="mark" id="mark" min="1" max="5" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                        </div>
